...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    services: Schema.Attribute.Component<'shared.services-summary', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    whoWeServe: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    whyUs: Schema.Attribute.Component<'shared.point-text', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomeSeoHomeSeo extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Home Seo';
    pluralName: 'home-seos';
    singularName: 'home-seo';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::project.project'
    >;
    projectCategory: Schema.Attribute.Relation<
      'manyToOne',
      'api::project-category.project-category'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::service.service'
    >;
    point: Schema.Attribute.Component<'shared.point-text', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
